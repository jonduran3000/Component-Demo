...
public abstract class BindableAdapter<T> extends BaseAdapter {
    ...
    public abstract View newView(@NonNull LayoutInflater inflater, int position, ViewGroup container);
    ...
    public View newDropDownView(@NonNull LayoutInflater inflater, int position, ViewGroup container) {
        return newView(inflater, position, container);
    }

    /** Bind the data for the specified {@code position} to the drop-down view. */
    public void bindDropDownView(@NonNull T item, int position, @NonNull View view) {
